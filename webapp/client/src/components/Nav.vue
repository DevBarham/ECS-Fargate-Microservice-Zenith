  ...
  <div id="navbar">
    ...
    >
      <b-navbar-brand>
        ...
        <router-link class="ml-2" to="/main" style="color: white"
          >Zenith
        </router-link>
      </b-navbar-brand>
      ...
      <b-collapse id="nav-collapse" is-nav>
        ...
        <b-navbar-nav class="ml-auto">
          <b-nav-form>
            ...
            ></b-form-input>
            <b-button size="sm" class="my-2 my-sm-0" type="submit" to="/search"
              >Search</b-button
            >
          </b-nav-form>
          ...
          <b-navbar-nav>
            <b-nav-item>
              <router-link class="ml-2" to="/about" style="color: white"
                >About
              </router-link>
            </b-nav-item>
          </b-navbar-nav>
